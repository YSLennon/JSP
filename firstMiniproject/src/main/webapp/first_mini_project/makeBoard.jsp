      ...
      <input name="title" id="titleBlock" placeholder="Title">
        ...
        <div class="mainBlock">
            ...
            <div class="tagZone">
				...
				<input name="addr" id="addrInput" class="bottomMenu" placeholder="지역" value='<%=userSession.getAddr()%>'>
	...
	var callback = function(result, status) {
	    if (status === kakao.maps.services.Status.OK) {
	    	...
	    	var drawingMapContainer = document.getElementById('map'),
	    	    drawingMap = { 
	    	        center: new kakao.maps.LatLng(y,x), // 지도의 중심좌표 변경해야함
	    	        level: 5 // 지도의 확대 레벨
	    	    };
