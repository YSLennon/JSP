...
<!--         <button id="removeCourse" type="button" onclick="removeOverlays()" class="bottomMenu">코스 지우기</button>
 -->        </div>
	...
	$.ajax({
			...
			success : function(response) {
				...
				var responseData = response.boardList[0];
				form.title.value = responseData.title;
				form.contents.value = responseData.contents;
				form.category.value = responseData.category;
				form.distance.value = responseData.distance;
				form.addr.value = responseData.addr;
				form.datetime.value = responseData.datetime;
	...
	function fnMakeBoard(){
		...
		requestAjaxMessage('modifyBoard',mapData);
	}
